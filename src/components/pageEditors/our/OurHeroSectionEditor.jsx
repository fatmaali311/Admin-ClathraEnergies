...
const OurHeroSectionEditor = ({ form, activeSection, PRIMARY_COLOR }) => {
    ...
    return (
        <Card title="Our Technology Hero" color={PRIMARY_COLOR} id="hero-section" className={activeCardClass}>
            <MediaUpload
                title="Hero Background / Center Image"
                name="our_hero_image"
                fileState={newFiles.our_hero_image}
                url={getAdminImageUrl(imageUrls?.our_hero_image)}

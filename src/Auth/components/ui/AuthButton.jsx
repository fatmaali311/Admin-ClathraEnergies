...
const AuthButton = ({
  ...
  const variantClasses = {
    primary: 'text-white',
    secondary: 'text-[#ADD0B3] border border-[#ADD0B3] bg-white hover:bg-gray-50',
    link: 'text-[#ADD0B3] hover:underline bg-transparent shadow-none hover:scale-100'
  };
  const widthClass = fullWidth ? 'w-full' : 'px-4';
  const buttonStyle = variant === 'primary' ? { backgroundColor: '#ADD0B3' } : {};
